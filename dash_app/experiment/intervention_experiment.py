...
def test_perclass_pra(model, dataset, batch_size=16,
    ...
    with torch.no_grad():
        ...
        loader = torch.utils.data.DataLoader(
            dataset, batch_size=batch_size, num_workers=torch.get_num_threads(),
            sampler=sampler, pin_memory=True)
        for image_batch, class_batch, img_dir in pbar(loader):
